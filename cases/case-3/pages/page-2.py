...
top_n_merken_line = st.number_input('Top N merken', 1, len(cum_sorted_brand), key='top_n_cum')

merken = Cars['merk'].unique()
gekozen_merk_line = st.multiselect("Kies een merk", merken, default=list(cum_sorted_brand[:top_n_merken_line].index), key='brands_cum')
...
top_n_merken_bar = st.number_input('Top N merken', 1, len(cum_sorted_brand), key='top_n_bar')
gekozen_merk_bar = st.multiselect("Kies een merk", merken, default=list(cum_sorted_brand[:top_n_merken_bar].index), key='brands_bar')
