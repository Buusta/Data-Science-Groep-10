...
top_n_merken_line = st.number_input('Top N merken', 1, len(cum_sorted_brand))
...
month_brand['yearmonth'] = pd.to_datetime(month_brand['jaar_tenaamstelling'].astype(str) + ' ' + month_brand['maand_tenaamstelling'].astype(str))
